...
BuilderGroup {
    ...
    Builder {
        ...
        BuilderConditions = {
            ...
            { OMBC, 'ShouldUpgradeLocalExtractors', { 'tech2', 240 } },
    ...
    Builder {
        ...
        BuilderConditions = {
            { OMBC, 'IsOvermindBrain', {} },
            { OMBC, 'ShouldUpgradeExtractors', {} },
            { OMBC, 'ShouldUpgradeRemoteExtractors', { 'tech2', 240 } },
            { OMBC, 'UnderExtractorUpgradeCap', { 'tech2' } },
        },
        FormRadius = 10000,
        BuilderType = 'Any',
    ...
    Builder {
        ...
        BuilderConditions = {
            ...
            { IBC, 'BrainNotLowPowerMode', {} },
            { OMBC, 'ShouldUpgradeExtractors', {} },
            { OMBC, 'ShouldUpgradeLocalExtractors', { 'tech3', 260 } },
    ...
    Builder {
        ...
        BuilderConditions = {
            { OMBC, 'IsOvermindBrain', {} },
            { OMBC, 'ShouldUpgradeExtractors', {} },
            { OMBC, 'ShouldUpgradeRemoteExtractors', { 'tech3', 260 } },
            { OMBC, 'UnderExtractorUpgradeCap', { 'tech3' } },
        },
        FormRadius = 10000,
        BuilderType = 'Any',
