...
local OvermindMacroController = import('/mods/OvermindAI/lua/AI/Overmind/MacroController.lua')
...
local ActionGroups = {
    ...
    strategic = {
        ...
        BuildAction({ Name = 'EconomySignals', Label = 'economy-signals', Group = 'strategic', StateSlice = 'EconomySignals', ModuleRef = OvermindEconomySignals, Inputs = { 'EcoState', 'EconomyLedger', 'OpponentModel', 'ZoneGraph', 'ZoneModel', 'IntelModel', 'Recovery' }, Outputs = { 'EconomySignals', 'EcoVelocity', 'EcoPressure' } }),
        BuildAction({ Name = 'MacroController', Label = 'macro-controller', Group = 'strategic', StateSlice = 'MacroController', ModuleRef = OvermindMacroController, Inputs = { 'EcoState', 'EconomySignals', 'EcoVelocity', 'EcoPressure', 'Recovery', 'EngineerState', 'UpgradeDirector' }, Outputs = { 'MacroController' } }),
        BuildAction({ Name = 'StrategicPlanner', Label = 'strategic-planner', Group = 'strategic', StateSlice = 'StrategicPlanner', ModuleRef = OvermindStrategicPlanner, Inputs = { 'ZoneGraph', 'IntelModel', 'EnemyClusterTracker', 'OpponentModel', 'EcoState', 'EconomySignals', 'EcoVelocity', 'EcoPressure', 'Recovery', 'RaidDefense', 'ForceDirector' }, Outputs = { 'StrategicPlanner' } }),
        ...
        BuildAction({ Name = 'EconomyPolicy', Label = 'economy-policy', Group = 'strategic', Method = 'UpdatePolicy', ModuleRef = OvermindEconomyOptimizer, Inputs = { 'EcoState', 'EconomySignals', 'EcoVelocity', 'EcoPressure', 'EconomyLedger', 'OpponentModel', 'StrategicPlanner', 'ZoneGraph', 'IntelModel', 'Recovery' }, Outputs = { 'EcoPolicy', 'MacroPhase' } }),
        ...
        BuildAction({ Name = 'ProductionDirector', Label = 'production-director', Group = 'strategic', StateSlice = 'ProductionDirector', ModuleRef = OvermindProductionDirector, Inputs = { 'EcoState', 'EcoPolicy', 'EcoVelocity', 'EcoPressure', 'EconomyLedger', 'StrategicPlanner', 'ForceDirector', 'IntelModel', 'ZoneGraph', 'ZoneModel', 'EnemyClusterTracker', 'OpponentModel', 'Recovery', 'ACUState', 'EngineerState' }, Outputs = { 'ProductionDirector' } }),
    },
    tactical = {
    ...
    ['macro-control'] = {
        ...
        BuildAction({ Name = 'UpgradeDirector', Label = 'upgrade-director', Group = 'macro-control', StateSlice = 'UpgradeDirector', ModuleRef = OvermindUpgradeDirector, Inputs = { 'ProductionDirector', 'EcoPolicy', 'EcoVelocity', 'EcoPressure', 'StrategicPlanner', 'ZoneGraph', 'ZoneModel', 'IntelModel', 'Recovery', 'EngineerState' }, Outputs = { 'UpgradeDirector', 'EconomyLedger' } }),
        BuildAction({ Name = 'EngineerDirector', Label = 'engineer-director', Group = 'macro-control', StateSlice = 'EngineerState', ModuleRef = OvermindEngineerDirector, Inputs = { 'ZoneGraph', 'IntelModel', 'EcoPolicy', 'EcoVelocity', 'EcoPressure', 'Recovery' }, Outputs = { 'EngineerState', 'EngineerDemand', 'EconomyLedger' } }),
    ...
    ['factory-control'] = {
        BuildAction({ Name = 'FactoryController', Label = 'factory-controller', Group = 'factory-control', StateSlice = 'FactoryController', ModuleRef = OvermindFactoryController, Inputs = { 'ProductionDirector', 'UpgradeDirector', 'ForceDirector', 'EcoPolicy', 'EcoVelocity', 'EngineerDemand', 'EconomyLedger', 'Recovery' }, Outputs = { 'FactoryController', 'EconomyLedger', 'Recovery' } }),
    },
    telemetry = {
        BuildAction({ Name = 'TelemetryCapture', Label = 'telemetry-capture', Group = 'telemetry', Method = 'Capture', StateSlice = 'Telemetry', ModuleRef = OvermindTelemetry, Inputs = { 'EcoState', 'EcoPolicy', 'EcoVelocity', 'EcoPressure', 'EconomyLedger', 'ProductionDirector', 'ForceDirector', 'StrategicPlanner', 'IntelModel', 'EnemyClusterTracker', 'ZoneGraph', 'RaidDefense' }, Outputs = { 'Telemetry', 'LastTelemetry' } }),
