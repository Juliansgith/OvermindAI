...
local ActionGroups = {
    ...
    ['macro-control'] = {
        ...
        BuildAction({ Name = 'EngineerDirector', Label = 'engineer-director', Group = 'macro-control', StateSlice = 'EngineerState', ModuleRef = OvermindEngineerDirector, Inputs = { 'ZoneGraph', 'IntelModel', 'EcoPolicy', 'EcoVelocity', 'EcoPressure', 'Recovery' }, Outputs = { 'EngineerState', 'EconomyLedger' } }),
    ...
    ['factory-control'] = {
        BuildAction({ Name = 'FactoryController', Label = 'factory-controller', Group = 'factory-control', StateSlice = 'FactoryController', ModuleRef = OvermindFactoryController, Inputs = { 'ProductionDirector', 'UpgradeDirector', 'ForceDirector', 'EcoPolicy', 'EcoVelocity', 'EconomyLedger', 'Recovery' }, Outputs = { 'FactoryController', 'EconomyLedger', 'Recovery' } }),
    },
    telemetry = {
