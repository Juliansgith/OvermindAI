...
local ActionGroups = {
    ...
    strategic = {
        ...
        BuildAction({ Name = 'IntelModel', Label = 'intel-model', Group = 'strategic', StateSlice = 'IntelModel', ModuleRef = OvermindIntelModel, Inputs = { 'ZoneGraph', 'ReconState', 'ZoneModel' }, Outputs = { 'IntelModel', 'PrimaryEnemyPos', 'LastEnemyContactTime' } }),
        ...
        BuildAction({ Name = 'OpponentModel', Label = 'opponent-model', Group = 'strategic', StateSlice = 'OpponentModel', ModuleRef = OvermindOpponentModel, Inputs = { 'IntelModel', 'ZoneModel', 'EnemyClusterTracker' }, Outputs = { 'OpponentModel' } }),
        BuildAction({ Name = 'GoalSelector', Label = 'goal-selector', Group = 'strategic', ModuleRef = OvermindGoalSelector, Inputs = { 'ZoneModel', 'IntelModel', 'OpponentModel', 'EcoState', 'Recovery', 'ForceDirector' }, Outputs = { 'StrategyGoal', 'StrategyGoalScore', 'StrategyUtilities', 'GoalAggressionModifier' } }),
        BuildAction({ Name = 'EconomyPolicy', Label = 'economy-policy', Group = 'strategic', Method = 'UpdatePolicy', ModuleRef = OvermindEconomyOptimizer, Inputs = { 'EcoState', 'OpponentModel', 'ZoneModel', 'Recovery' }, Outputs = { 'EcoPolicy', 'MacroPhase' } }),
