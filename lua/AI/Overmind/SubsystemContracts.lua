...
local ActionGroups = {
    ...
    strategic = {
        ...
        BuildAction({ Name = 'OpponentModel', Label = 'opponent-model', Group = 'strategic', StateSlice = 'OpponentModel', ModuleRef = OvermindOpponentModel, Inputs = { 'IntelModel', 'EnemyClusterTracker' }, Outputs = { 'OpponentModel' } }),
