...
local ActionGroups = {
    ...
    ['macro-control'] = {
        ...
        BuildAction({ Name = 'EngineerDirector', Label = 'engineer-director', Group = 'macro-control', Method = 'Run', StateSlice = 'EngineerState', ModuleRef = OvermindEngineerDirector, Inputs = { 'ZoneGraph', 'IntelModel', 'Recovery' }, Outputs = { 'EngineerState' } }),
